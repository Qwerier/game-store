...
namespace API.Entities
{
    ...
    public class Basket
    {
        ...
        public string? ClientSecret { get; set; } // client communicates with stripe owner: Client

        public string? PaymentIntentId { get; set; } // in case he modifies basket, Intent is modified owner: Server
