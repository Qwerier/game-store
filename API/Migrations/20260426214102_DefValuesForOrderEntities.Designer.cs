...
namespace API.Migrations
{
    ...
    [Migration("20260426214102_DefValuesForOrderEntities")]
    partial class DefValuesForOrderEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.OrderSubtypes.Order", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("API.Entities.OrderSubtypes.OrderItem", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("API.Entities.OrderSubtypes.Order", b =>
                {
                    b.OwnsOne("API.Entities.OrderSubtypes.PaymentSummary", "PaymentSummary", b1 =>
                        {
                    ...
                    b.OwnsOne("API.Entities.OrderSubtypes.ShippingAddress", "ShippingAddress", b1 =>
                        {
                            b1.Property<string>("OrderId")
                                .HasColumnType("text");
            ...
            modelBuilder.Entity("API.Entities.OrderSubtypes.OrderItem", b =>
                {
                    b.HasOne("API.Entities.OrderSubtypes.Order", null)
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId");

                    b.OwnsOne("API.Entities.OrderSubtypes.GameItemOrdered", "ItemOrdered", b1 =>
                        {
